...
// kindergardens //
#poi_label [maki="school"][type="Kindergarten"] {
  text-name: @name;
  text-face-name: @bold;  
  text-fill: @kindergarten;  
  text-size: 12;
  text-character-spacing: 0.5;  
  ...
  marker-file: url("img/maki/school-18.svg");
  marker-fill: darken(@kindergarten, 3);   
...
// Scalerank <= 3
#poi_label [maki!='park'][maki!="school"][type!='Aerodrome'][type!='Rail Station'][type!='Peak'][scalerank<=3] {
  [zoom<14],
...
// Scalerank = 4
#poi_label [maki!='park'][maki!="school"][type!='Aerodrome'][type!='Rail Station'][type!='Peak'][scalerank=4] {
  [zoom>=17][localrank<=1],
  [zoom>=18][localrank<=8],
  [zoom>=19] {
  text-name: @name;
